...
const SignUpPage = () => {
    ...
    return (
        <div className="flex justify-center items-center  bg-[#081019] flex-col  max-md:pl-5 max-md:pr-5 h-screen w-screen">
            <h1 className="text-3xl font-bold text-[#efefef]"> Community</h1>
            <form onSubmit={handleLogin} className="max-w-5xl w-1/2 max-md:w-full p-8 flex justify-center items-center border-[#122336ee]  gap-5 flex-col bg-dark shadow-md rounded-2xl my-16 border-secondary border-[1px]">
                ...
                <input
                    ...
                    className='p-[10px] w-[450px] max-lg:w-full border-[2px] outline-none focus:border-[#304762]  rounded-[5px] text-[#dbdbdb] border-[#111c29]'
                ...
                <button
                    ...
                    className='p-[10px] w-[450px]   max-lg:w-full outline-none  border-[2px]  rounded-[5px] text-[#dbdbdb] border-[#111c29] hover:bg-[#0f1a24] transition ease-in-out delay-150'
                >
                    Sign Up
                </button>
                <small className="text-zinc-300">
                    Don&apos;t have an account?{" "}
                    <NavLink className="text-primary hover:underline outline-none text-[#7c9eb8]" to="/government-engineering-college-siwan/community/signin">
                        Sign In
                    </NavLink>
                </small>
            </form>
