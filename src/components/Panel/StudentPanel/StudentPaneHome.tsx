...
function StudentPaneHome() {
    ...
    return (
        <>
            <section style={{ transition: 'all 1s' }} className={`w-[100%] h-[100vh] bg-[#0d1526] overflow-auto flex   ${SideBarOpenClose ? " justify-start" : " justify-end"} `}>
                <StudentSideNavBar SetSideBarOpenClose={SetSideBarOpenClose} SideBarOpenClose={SideBarOpenClose} getdata={getdata} />
                <section style={{ transition: 'all 1s' }} className={` w-full h-[100vh] flex flex-col justify-start ${SideBarOpenClose ? " items-center" : " items-end"} max-lg:w-full capitalize text-[20px] text-[#e0fcff] `}>
                    <StudentProfileHeader SetSideBarOpenClose={SetSideBarOpenClose} SideBarOpenClose={SideBarOpenClose} />
                    <div style={{ transition: 'all 1s' }} className={`${SideBarOpenClose ? " w-[100%]" : " w-[80%]"} p-[20px] justify-center items-center max-lg:w-full h-full capitalize text-[20px] text-center max-sm-m:text-[14px] text-[#e0fcff] max-sm-m:p-1`}>
                        <Outlet />
                    </div>
                </section>
            </section>
