...
import UhrakhelAnimatedLoader from '../Loader/UhrakhelAnimatedLoader.tsx';
...
function BgmiEventRegistration() {
    ...
    const PermissionCheck = async () => {
        try {
            ...
            if (res.status === 200) {
                ...
                SetPermission(data.bgmi_registration_permission);
                SetIsLoading(false);
            } else {
                SetPermission(1)
                SetIsLoading(false);
    ...
    const submidformdata = async (event) => {
        ...
        try {
            ...
            const res = await fetch(baseUrl + '/api/participant/bgmi/tech/form', {
                method: 'POST',
                headers: {
    ...
    const selectparticipant = () => {
        const inputsectiondata = Object(document.querySelector('#selectparticipant'))?.value;
    ...
    const selectHandelClickEvent = (event) => {
        const inputsectiondata = Object(document.querySelector('#inputsectionleader'))?.value;
    ...
    const selectHandelClickEvent1 = (event) => {
        const inputsectiondata1 = Object(document.querySelector('#inputsectionmember1'))?.value;
    ...
    const selectHandelClickEvent2 = (event) => {
        const inputsectiondata2 = Object(document.querySelector('#inputsectionmember2'))?.value;
    ...
    const selectHandelClickEvent3 = (event) => {
        const inputsectiondata3 = Object(document.querySelector('#inputsectionmember3'))?.value;
